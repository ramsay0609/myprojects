        ...
        for task, dataset in datasets.items():
            ...
            if task in ["SST-2"]:
                ...
                for split, lines in dataset.items():
                    ...
                    with open(os.path.join(setting_dir, f"{split}.tsv"), "w", encoding='utf8') as f:
                        for line in lines:
                            f.write(line)
            else:
                # Other datasets
            ...
            if task in ["SST-2"]:
                with open(os.path.join(setting_dir, "train.tsv"), "w", encoding='utf8') as f:
                    ...
                    for label in label_list:
                        for line in label_list[label][:k]:
                            f.write(line)
                name = "dev.tsv"
                with open(os.path.join(setting_dir, name), "w", encoding='utf8') as f:
                    for line in train_header:
                        f.write(line)
                    for label in label_list:
